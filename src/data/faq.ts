export const faqData = [
  ...
  },
  {
    ...
    answer:
      "Semua mahasiswa aktif Universitas Negeri Makassar dari berbagai jurusan dan fakultas dipersilakan untuk bergabung, tanpa memandang tingkat kemampuan.",
  },
  {
    question: "Apakah ada biaya untuk bergabung dengan GDGoC UNM?",
    answer:
      "Tidak ada biaya sama sekali. Bergabung di GDGoC UNM gratis dan terbuka untuk semua mahasiswa yang memiliki minat di bidang teknologi.",
  },
  {
    question: "Bagaimana cara mendaftar atau bergabung dengan GDGoC UNM?",
    answer:
      "Kamu bisa bergabung melalui tautan resmi di website kami atau mengikuti pengumuman open recruitment yang biasanya diumumkan di media sosial GDGoC UNM.",
  },
  {
