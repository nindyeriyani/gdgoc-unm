...
export default function TeamSection() {
  ...
  return (
    ...
    >
      ...
      <button
        onClick={handlePrev}
        className="absolute left-2 lg:left-32 top-1/2 -translate-y-1/2 bg-transparent border-[2px] border-[#FF8D28] p-2 hover:p-3 rounded-full text-[#FF8D28] hover:bg-[#FF8D28] hover:text-white transition-all duration-300 z-10 flex items-center justify-center"
      >
      ...
      >
        <FaArrowRight size={16} className="cursor-pointer" />
      </button>
    </section>
  );
}
